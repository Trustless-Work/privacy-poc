...
/** Invert `encryptAllowance` once the spender has recovered the delegation key. */
export const decryptAllowance = (aTilde: bigint, dvk: bigint, sigmaA: bigint): bigint =>
  frMod(aTilde - poseidonWithDomain(DOMAIN.ENCRYPTED_ALLOWANCE, [dvk, sigmaA]));
