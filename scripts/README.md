...
- run disclosure verification and auditor decryption checks.

Scripts must require explicit testnet configuration and refuse mainnet until the repository's production-readiness policy changes.
